...
def popular_modelos():
    ...
    # estimadores = []
    # for nome, mod in modelos_regressores.items():
    #     estimadores.append((nome, mod))
    # for nome, mod in modelos_classificadores.items():
    #     estimadores.append((nome, mod))

    # modelo_stack = StackingClassifier(estimators=estimadores)
