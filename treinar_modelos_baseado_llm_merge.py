...
# OBS: Os modelos que estão aqui com parâmetros p/ cada competência são substituídos após o gridsearch, isso tudo ficou de placeholder
...
def popular_modelos_lineares():
    ...
    modelos_regressores[f"TheilSenRegressor"] = TheilSenRegressor()
    modelos_regressores[f"HuberRegressor"] = HuberRegressor(max_iter=4000)
    modelos_regressores[f"Lars"] = Lars()
    modelos_regressores[f"ARDRegression"] = ARDRegression()

    modelos_regressores["RidgeC1"] = Ridge(alpha=0.1, solver='auto') #
    modelos_regressores["RidgeC2"] = Ridge(alpha=0.005, solver='auto') #
    modelos_regressores["RidgeC3"] = Ridge(alpha=1, solver='auto') #
    modelos_regressores["RidgeC4"] = Ridge(alpha=0.1, solver='auto') #
    modelos_regressores["RidgeC5"] = Ridge(alpha=0.5, solver='auto') #

    modelos_regressores["LassoC1"] = Lasso(alpha=0.005, selection='cyclic') #
    modelos_regressores["LassoC2"] = Lasso(alpha=0.005, selection='cyclic') #
    modelos_regressores["LassoC3"] = Lasso(alpha=0.5, selection='cyclic') #
    modelos_regressores["LassoC4"] = Lasso(alpha=0.1, selection='cyclic') #
    modelos_regressores["LassoC5"] = Lasso(alpha=0.1, selection='cyclic') #

    modelos_regressores["LassoLarsC1"] = LassoLars(alpha=0.005) #
    modelos_regressores["LassoLarsC2"] = LassoLars(alpha=0.005) #
    modelos_regressores["LassoLarsC3"] = LassoLars(alpha=0.5) #
    modelos_regressores["LassoLarsC4"] = LassoLars(alpha=0.1) #
    modelos_regressores["LassoLarsC5"] = LassoLars(alpha=0.1) #

    modelos_regressores["ElasticNetC1"] = ElasticNet(alpha=0.0005, l1_ratio=0.5) #
    modelos_regressores["ElasticNetC2"] = ElasticNet(alpha=0.0005, l1_ratio=0.75) #
    modelos_regressores["ElasticNetC3"] = ElasticNet(alpha=0.1, l1_ratio=0.75) #
    modelos_regressores["ElasticNetC4"] = ElasticNet(alpha=0.1, l1_ratio=0.75) #
    modelos_regressores["ElasticNetC5"] = ElasticNet(alpha=0.005, l1_ratio=0.25) #
    ...
    modelos_regressores["TweedieRegressorC1"] = TweedieRegressor(alpha=1,power=1,solver='lbfgs') #
    modelos_regressores["TweedieRegressorC2"] = TweedieRegressor(alpha=0.0001, power=0, solver='lbfgs') #
    modelos_regressores["TweedieRegressorC3"] = TweedieRegressor(alpha=0.0005, power=0, solver='lbfgs') #
    modelos_regressores["TweedieRegressorC4"] = TweedieRegressor(alpha=0.0005, power=0, solver='lbfgs') #
    modelos_regressores["TweedieRegressorC5"] = TweedieRegressor(alpha=0.5, power=1, solver='lbfgs') #
...
def popular_modelos_knn():
    ...
    modelos_classificadores['KNeighborsClassifierC1'] = KNeighborsClassifier(n_neighbors=21, weights='uniform') #
    modelos_classificadores['KNeighborsClassifierC2'] = KNeighborsClassifier(n_neighbors=29, weights='distance') #
    modelos_classificadores['KNeighborsClassifierC3'] = KNeighborsClassifier(n_neighbors=29, weights='uniform') #
    modelos_classificadores['KNeighborsClassifierC4'] = KNeighborsClassifier(n_neighbors=9, weights='uniform') #
    modelos_classificadores['KNeighborsClassifierC5'] = KNeighborsClassifier(n_neighbors=37, weights='uniform') #

    modelos_regressores['KNeighborsRegressorC1'] = KNeighborsRegressor(n_neighbors=5, weights='uniform') #
    modelos_regressores['KNeighborsRegressorC2'] = KNeighborsRegressor(n_neighbors=25, weights='uniform') #
    modelos_regressores['KNeighborsRegressorC3'] = KNeighborsRegressor(n_neighbors=25, weights='uniform') #
    modelos_regressores['KNeighborsRegressorC4'] = KNeighborsRegressor(n_neighbors=33, weights='uniform') #
    modelos_regressores['KNeighborsRegressorC5'] = KNeighborsRegressor(n_neighbors=33, weights='uniform') #
...
def popular_modelos_redes_neurais():
    ...
    modelos_classificadores["MLPClassifierC1"] = MLPClassifier(alpha=0.0001, batch_size=64, hidden_layer_sizes=(250, 150, 100, 50), solver='lbfgs', early_stopping=True) #
    modelos_classificadores["MLPClassifierC2"] = MLPClassifier(alpha=0.1, batch_size=64, hidden_layer_sizes=(100, 50), solver='lbfgs', early_stopping=True) #
    modelos_classificadores["MLPClassifierC3"] = MLPClassifier(alpha=0.1, batch_size=64, hidden_layer_sizes=(250, 150, 100, 50), solver='lbfgs', early_stopping=True) #
    modelos_classificadores["MLPClassifierC4"] = MLPClassifier(alpha=0.0001, batch_size=64, hidden_layer_sizes=(250, 150, 100, 50), solver='lbfgs', early_stopping=True) #
    modelos_classificadores["MLPClassifierC5"] = MLPClassifier(alpha=0.1, batch_size=16, hidden_layer_sizes=(100, 50), solver='adam', early_stopping=True) #

    modelos_regressores["MLPRegressorC1"] = MLPRegressor(alpha=0.1, batch_size=16, hidden_layer_sizes=(100,), solver='lbfgs', early_stopping=True) #
    modelos_regressores["MLPRegressorC2"] = MLPRegressor(alpha=0.1, batch_size=16, hidden_layer_sizes=(250, 150, 100, 50), solver='adam', early_stopping=True) #
    modelos_regressores["MLPRegressorC3"] = MLPRegressor(alpha=0.0001, batch_size=16, hidden_layer_sizes=(100), solver='adam', early_stopping=True) #
    modelos_regressores["MLPRegressorC4"] = MLPRegressor(alpha=0.0001, batch_size=16, hidden_layer_sizes=(100, 50), solver='adam', early_stopping=True) #
    modelos_regressores["MLPRegressorC5"] = MLPRegressor(alpha=0.0001, batch_size=64, hidden_layer_sizes=(100,), solver='lbfgs', early_stopping=True) #

def popular_outros_modelos():
    global modelos_classificadores, modelos_regressores

    modelos_classificadores["HistGradientBoostingClassifierC1"] = HistGradientBoostingClassifier(learning_rate=0.1, max_leaf_nodes=31, class_weight="balanced") #
    modelos_classificadores["HistGradientBoostingClassifierC2"] = HistGradientBoostingClassifier(learning_rate=0.05, max_leaf_nodes=31, class_weight="balanced") #
    modelos_classificadores["HistGradientBoostingClassifierC3"] = HistGradientBoostingClassifier(learning_rate=0.05, max_leaf_nodes=15, class_weight="balanced") #
    modelos_classificadores["HistGradientBoostingClassifierC4"] = HistGradientBoostingClassifier(learning_rate=0.1, max_leaf_nodes=15, class_weight="balanced") #
    modelos_classificadores["HistGradientBoostingClassifierC5"] = HistGradientBoostingClassifier(learning_rate=0.05, max_leaf_nodes=15, class_weight="balanced") #

    modelos_classificadores["AdaBoostClassifierC1"] = AdaBoostClassifier(learning_rate=1, n_estimators=100) #
    modelos_classificadores["AdaBoostClassifierC2"] = AdaBoostClassifier(learning_rate=5, n_estimators=50) #
    modelos_classificadores["AdaBoostClassifierC3"] = AdaBoostClassifier(learning_rate=1, n_estimators=150) #
    modelos_classificadores["AdaBoostClassifierC4"] = AdaBoostClassifier(learning_rate=1, n_estimators=150) #
    modelos_classificadores["AdaBoostClassifierC5"] = AdaBoostClassifier(learning_rate=0.5, n_estimators=50) #

    modelos_classificadores["RandomForestClassifierC1"] = RandomForestClassifier(max_features=1, n_estimators=150, class_weight="balanced") #
    modelos_classificadores["RandomForestClassifierC2"] = RandomForestClassifier(max_features=1, n_estimators=50, class_weight="balanced") #
    ...
    modelos_classificadores["RandomForestClassifierC4"] = RandomForestClassifier(max_features=1, n_estimators=100, class_weight="balanced") #
    modelos_classificadores["RandomForestClassifierC5"] = RandomForestClassifier(max_features=1, n_estimators=50, class_weight="balanced") #

    modelos_regressores["HistGradientBoostingRegressorC1"] = HistGradientBoostingRegressor(learning_rate=0.2, max_leaf_nodes=15) #
    modelos_regressores["HistGradientBoostingRegressorC2"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=15) #
    modelos_regressores["HistGradientBoostingRegressorC3"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=15) #
    modelos_regressores["HistGradientBoostingRegressorC4"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=31) #
    modelos_regressores["HistGradientBoostingRegressorC5"] = HistGradientBoostingRegressor(learning_rate=0.1, max_leaf_nodes=15) #
    
    modelos_regressores["AdaBoostRegressorC1"] = AdaBoostRegressor(learning_rate=1, n_estimators=150) #
    modelos_regressores["AdaBoostRegressorC2"] = AdaBoostRegressor(learning_rate=0.5, n_estimators=50) #
    modelos_regressores["AdaBoostRegressorC3"] = AdaBoostRegressor(learning_rate=0.5, n_estimators=10) #
    modelos_regressores["AdaBoostRegressorC4"] = AdaBoostRegressor(learning_rate=0.5, n_estimators=150) #
    modelos_regressores["AdaBoostRegressorC5"] = AdaBoostRegressor(learning_rate=5, n_estimators=100) #

    modelos_regressores["RandomForestRegressorC1"] = RandomForestRegressor(max_features=1, n_estimators=150) #
    modelos_regressores["RandomForestRegressorC2"] = RandomForestRegressor(max_features='sqrt', n_estimators=200) #
    modelos_regressores["RandomForestRegressorC3"] = RandomForestRegressor(max_features=1, n_estimators=200) #
    modelos_regressores["RandomForestRegressorC4"] = RandomForestRegressor(max_features=0.3, n_estimators=50) #
    modelos_regressores["RandomForestRegressorC5"] = RandomForestRegressor(max_features='sqrt', n_estimators=200) #
...
arquivo_dataset = "grades_comparison.csv"
arquivo_dataset_2 = "indicadores_atualizados.csv"
...
def dividir_dados(dados: pd.DataFrame, coluna_alvo: str, classificador = False):
    ...
    """
    # "id,nota_c1,nota_c2,nota_c3,nota_c4,nota_c5,nota_c1_gemma4,nota_c2_gemma4,nota_c3_gemma4,nota_c4_gemma4,nota_c5_gemma4,nota_c1_qwen2.5,nota_c2_qwen2.5,nota_c3_qwen2.5,nota_c4_qwen2.5,nota_c5_qwen2.5,nota_c1_qwen3,nota_c2_qwen3,nota_c3_qwen3,nota_c4_qwen3,nota_c5_qwen3,nota_c1_deepseek-r1,nota_c2_deepseek-r1,nota_c3_deepseek-r1,nota_c4_deepseek-r1,nota_c5_deepseek-r1"

    X = dados.drop(columns=["id","nota_c1","nota_c2",
    ...
    X_test, y_test = X.iloc[:209], Y.iloc[:209]
    X_train, y_train = X.iloc[209:], Y.iloc[209:]
...
def avaliar_modelos(X_teste, Y_teste, X_teste_normalizado, competencia=None):
    ...
    X_teste_array = X_teste.values

    acumulador = np.zeros(X_teste.shape[1], dtype=int)

    for nome_modelo, modelo in modelos_regressores.items():
        try:
            sel = SelectFromModel(modelo, prefit=True)
            mask = sel.get_support()
            vetor = mask.astype(int)
            acumulador += mask
            print(f"{nome_modelo:<35}: {vetor.tolist()}")
            
            X_novo = sel.transform(X_teste_array)
        except Exception as e:
            print(f"{nome_modelo:<35}: ------------------------------------------------------------------")
            continue

    for nome_modelo, modelo in modelos_classificadores.items():
        try:
            sel = SelectFromModel(modelo, prefit=True)
            mask = sel.get_support()
            vetor = mask.astype(int)
...
arquivo_original_dataset = "grades_comparison_single_r1.csv"
sufixos = ["2", "3"] #, "4", "5", "6"]

arquivo_dataset_2 = "indicadores_atualizados.csv"
colunas_para_adicionar = ["n_tokens","similaridade_proposta_bertimbau","numero_palavras_diferentes","n_adjetivos","similaridade_direitos_humanos_bertimbau","similaridade_tit_1_constituicao_bertimbau"]

if __name__ == "__main__":
    dados_originais = carregar_dados(arquivo_original_dataset)
    
    dados_novos = carregar_dados(arquivo_dataset_2)
    dados_novos_filtrados = dados_novos[colunas_para_adicionar]
    
    notas = ['nota_c1', 'nota_c2', 'nota_c3', 'nota_c4', 'nota_c5']
    modelos = ['gemma4', 'qwen2.5', 'qwen3', 'deepseek-r1']

    dados_p_merge = []

    for pref in sufixos:
        dados_p_merge.append(carregar_dados(arquivo_original_dataset.replace('r1', f'r{pref}')))

    colunas_a_renomear = {}

    for nota in notas:
        for modelo in modelos:
            colunas_a_renomear[f"{nota}_{modelo}"] = f"1_{nota}_{modelo}"
    
    dados_originais = dados_originais.rename(columns=colunas_a_renomear)

    for i, df in enumerate(dados_p_merge):
        colunas_a_renomear = {}

        for nota in notas:
            for modelo in modelos:
                colunas_a_renomear[f"{nota}_{modelo}"] = f"{i+2}_{nota}_{modelo}"
        
        dados_p_merge[i] = dados_p_merge[i].rename(columns=colunas_a_renomear)
        dados_p_merge[i] = dados_p_merge[i].drop(columns=notas)
        dados_p_merge[i] = dados_p_merge[i].drop(columns=['id'])
        print(df.head())
        
    tds_prefixos = ["1"] + sufixos

    for df in dados_p_merge:
        dados_originais = pd.concat([
            dados_originais.reset_index(drop=True), 
            df.reset_index(drop=True)
        ], axis=1)

    dados_originais = pd.concat([
        dados_originais.reset_index(drop=True), 
        dados_novos_filtrados.reset_index(drop=True)
    ], axis=1)

    # pd.set_option('display.max_columns', None)
    # pd.set_option('display.max_rows', None)
    # print(dados_originais.columns.tolist())
    ...
    for nota in notas:
        ...
        for val in notas:
            if val != nota:
                for modelo in modelos:
                    for pref in tds_prefixos:
                        colunas_a_dropar.append(f'{pref}_{val}_{modelo}')
