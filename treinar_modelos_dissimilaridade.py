...
def popular_modelos_lineares():
    ...
    modelos_regressores["RidgeC1"] = Ridge(alpha=1, solver='auto') 
    modelos_regressores["RidgeC2"] = Ridge(alpha=0.001, solver='lsqr')
    modelos_regressores["RidgeC3"] = Ridge(alpha=0.0001, solver='auto')
    modelos_regressores["RidgeC4"] = Ridge(alpha=1, solver='auto')
    modelos_regressores["RidgeC5"] = Ridge(alpha=0.005, solver='auto')

    modelos_regressores["LassoC1"] = Lasso(alpha=0.005, selection='cyclic')
    modelos_regressores["LassoC2"] = Lasso(alpha=0.0001, selection='cyclic')
    modelos_regressores["LassoC3"] = Lasso(alpha=0.005, selection='cyclic')
    modelos_regressores["LassoC4"] = Lasso(alpha=0.005, selection='cyclic')
    modelos_regressores["LassoC5"] = Lasso(alpha=0.0005, selection='cyclic')

    modelos_regressores["LassoLarsC1"] = LassoLars(alpha=0.001)
    ...
    modelos_regressores["LassoLarsC5"] = LassoLars(alpha=0.001)

    modelos_regressores["ElasticNetC1"] = ElasticNet(alpha=0.0005, l1_ratio=0.75)
    modelos_regressores["ElasticNetC2"] = ElasticNet(alpha=0.0001, l1_ratio=0.75)
    modelos_regressores["ElasticNetC3"] = ElasticNet(alpha=0.0001, l1_ratio=0.75)
    modelos_regressores["ElasticNetC4"] = ElasticNet(alpha=0.0001, l1_ratio=0.25)
    modelos_regressores["ElasticNetC5"] = ElasticNet(alpha=0.0001, l1_ratio=0.75)
    ...
    modelos_regressores["TweedieRegressorC1"] = TweedieRegressor(alpha=0.0001, power=0,solver='lbfgs')
    modelos_regressores["TweedieRegressorC2"] = TweedieRegressor(alpha=0.0001, power=1, solver='lbfgs')
    modelos_regressores["TweedieRegressorC3"] = TweedieRegressor(alpha=0.0005, power=1, solver='newton-cholesky')
    modelos_regressores["TweedieRegressorC4"] = TweedieRegressor(alpha=0.005, power=1, solver='lbfgs')
    modelos_regressores["TweedieRegressorC5"] = TweedieRegressor(alpha=0.0001, power=1, solver='lbfgs')
...
def popular_modelos_knn():
    ...
    modelos_classificadores['KNeighborsClassifierC1'] = KNeighborsClassifier(n_neighbors=9, weights='uniform')
    modelos_classificadores['KNeighborsClassifierC2'] = KNeighborsClassifier(n_neighbors=9, weights='distance')
    modelos_classificadores['KNeighborsClassifierC3'] = KNeighborsClassifier(n_neighbors=9, weights='distance')
    modelos_classificadores['KNeighborsClassifierC4'] = KNeighborsClassifier(n_neighbors=5, weights='uniform')
    modelos_classificadores['KNeighborsClassifierC5'] = KNeighborsClassifier(n_neighbors=17, weights='distance')

    modelos_regressores['KNeighborsRegressorC1'] = KNeighborsRegressor(n_neighbors=17, weights='uniform')
    modelos_regressores['KNeighborsRegressorC2'] = KNeighborsRegressor(n_neighbors=17, weights='distance')
    modelos_regressores['KNeighborsRegressorC3'] = KNeighborsRegressor(n_neighbors=9, weights='distance')
    modelos_regressores['KNeighborsRegressorC4'] = KNeighborsRegressor(n_neighbors=9, weights='uniform')
    modelos_regressores['KNeighborsRegressorC5'] = KNeighborsRegressor(n_neighbors=21, weights='distance')
...
def popular_modelos_redes_neurais():
    ...
    modelos_classificadores["MLPClassifierC1"] = MLPClassifier(alpha=0.0001, batch_size=64, hidden_layer_sizes=(100, 50), solver='lbfgs', early_stopping=True)
    modelos_classificadores["MLPClassifierC2"] = MLPClassifier(alpha=0.1, batch_size=16, hidden_layer_sizes=(100, 50), solver='lbfgs', early_stopping=True)
    modelos_classificadores["MLPClassifierC3"] = MLPClassifier(alpha=0.1, batch_size=16, hidden_layer_sizes=(200, 100, 50), solver='lbfgs', early_stopping=True)
    modelos_classificadores["MLPClassifierC4"] = MLPClassifier(alpha=0.1, batch_size=64, hidden_layer_sizes=(100, 50), solver='lbfgs', early_stopping=True)
    modelos_classificadores["MLPClassifierC5"] = MLPClassifier(alpha=0.1, batch_size=16, hidden_layer_sizes=(200, 100, 50), solver='lbfgs', early_stopping=True)

    modelos_regressores["MLPRegressorC1"] = MLPRegressor(alpha=0.1, batch_size=64, hidden_layer_sizes=(200, 100, 50), solver='adam', early_stopping=True)
    modelos_regressores["MLPRegressorC2"] = MLPRegressor(alpha=0.0001, batch_size=16, hidden_layer_sizes=(200, 100, 50), solver='lbfgs', early_stopping=True)
    modelos_regressores["MLPRegressorC3"] = MLPRegressor(alpha=0.0001, batch_size=16, hidden_layer_sizes=(200, 100, 50), solver='lbfgs', early_stopping=True)
    modelos_regressores["MLPRegressorC4"] = MLPRegressor(alpha=0.0001, batch_size=64, hidden_layer_sizes=(200, 100, 50), solver='lbfgs', early_stopping=True)
    modelos_regressores["MLPRegressorC5"] = MLPRegressor(alpha=0.0001, batch_size=64, hidden_layer_sizes=(100, 50), solver='lbfgs', early_stopping=True)


def popular_outros_modelos():
    global modelos_classificadores, modelos_regressores

    modelos_classificadores["HistGradientBoostingClassifierC1"] = HistGradientBoostingClassifier(learning_rate=0.05, max_leaf_nodes=31, class_weight="balanced")
    modelos_classificadores["HistGradientBoostingClassifierC2"] = HistGradientBoostingClassifier(learning_rate=0.1, max_leaf_nodes=31, class_weight="balanced")
    ...
    modelos_classificadores["HistGradientBoostingClassifierC4"] = HistGradientBoostingClassifier(learning_rate=0.05, max_leaf_nodes=31, class_weight="balanced")
    modelos_classificadores["HistGradientBoostingClassifierC5"] = HistGradientBoostingClassifier(learning_rate=0.05, max_leaf_nodes=45, class_weight="balanced")

    modelos_classificadores["AdaBoostClassifierC1"] = AdaBoostClassifier(learning_rate=1, n_estimators=150)
    modelos_classificadores["AdaBoostClassifierC2"] = AdaBoostClassifier(learning_rate=1, n_estimators=150)
    modelos_classificadores["AdaBoostClassifierC3"] = AdaBoostClassifier(learning_rate=0.5, n_estimators=150)
    modelos_classificadores["AdaBoostClassifierC4"] = AdaBoostClassifier(learning_rate=1, n_estimators=150)
    modelos_classificadores["AdaBoostClassifierC5"] = AdaBoostClassifier(learning_rate=1, n_estimators=10)

    modelos_classificadores["RandomForestClassifierC1"] = RandomForestClassifier(max_features=0.3, n_estimators=150, class_weight="balanced")
    modelos_classificadores["RandomForestClassifierC2"] = RandomForestClassifier(max_features=0.3, n_estimators=50, class_weight="balanced")
    modelos_classificadores["RandomForestClassifierC3"] = RandomForestClassifier(max_features=0.3, n_estimators=200, class_weight="balanced")
    modelos_classificadores["RandomForestClassifierC4"] = RandomForestClassifier(max_features=0.3, n_estimators=150, class_weight="balanced")
    modelos_classificadores["RandomForestClassifierC5"] = RandomForestClassifier(max_features=1, n_estimators=200, class_weight="balanced")

    modelos_regressores["HistGradientBoostingRegressorC1"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=15)
    modelos_regressores["HistGradientBoostingRegressorC2"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=45)
    modelos_regressores["HistGradientBoostingRegressorC3"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=15)
    modelos_regressores["HistGradientBoostingRegressorC4"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=15)
    modelos_regressores["HistGradientBoostingRegressorC5"] = HistGradientBoostingRegressor(learning_rate=0.05, max_leaf_nodes=45)
    
    modelos_regressores["AdaBoostRegressorC1"] = AdaBoostRegressor(learning_rate=1, n_estimators=100)
    modelos_regressores["AdaBoostRegressorC2"] = AdaBoostRegressor(learning_rate=1, n_estimators=100)
    modelos_regressores["AdaBoostRegressorC3"] = AdaBoostRegressor(learning_rate=1, n_estimators=100)
    modelos_regressores["AdaBoostRegressorC4"] = AdaBoostRegressor(learning_rate=0.5, n_estimators=150)
    modelos_regressores["AdaBoostRegressorC5"] = AdaBoostRegressor(learning_rate=1, n_estimators=10)

    modelos_regressores["RandomForestRegressorC1"] = RandomForestRegressor(max_features=0.3, n_estimators=150)
    modelos_regressores["RandomForestRegressorC2"] = RandomForestRegressor(max_features='sqrt', n_estimators=150)
    modelos_regressores["RandomForestRegressorC3"] = RandomForestRegressor(max_features='sqrt', n_estimators=100)
    modelos_regressores["RandomForestRegressorC4"] = RandomForestRegressor(max_features=0.3, n_estimators=100)
...
arquivo_dataset = "indicadores_dissimilaridade_10.csv"
...
def dividir_dados(dados: pd.DataFrame, coluna_alvo: str, classificador = False, competencia_alvo = None):
    """
        Divide os dados em X_treino, X_teste, Y_treino, Y_teste
    """

    colunas_a_dropar_extras = []

    for comp in ["C1", "C2", "C3", "C4", "C5"]:
        if competencia_alvo is not None:
            if comp == competencia_alvo:
                continue
        
        for nota in ["0", "40", "80", "120", "160", "200"]:
            for ref in range(0,10):
                colunas_a_dropar_extras.append(f"dissimilaridade_emb_{ref}_{comp.lower()}_{nota}")
                colunas_a_dropar_extras.append(f"dissimilaridade_vet_{ref}_{comp.lower()}_{nota}")

    X = dados.drop(columns=["Unnamed: 0", "id","nota_total","nota_c1","nota_c2",
                            ...
                            ] + colunas_a_dropar_extras) # removendo colunas que nao sao indicadores
...
if __name__ == "__main__":
    ...
    for nota in notas:
        ...
        X_treino, X_teste, Y_treino, Y_teste = dividir_dados(dados, nota, True, competencia_alvo = competencia)
